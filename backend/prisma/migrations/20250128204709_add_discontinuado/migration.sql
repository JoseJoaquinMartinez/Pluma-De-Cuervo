/*
  ...
  - The values [TERMINADO] on the enum `BookStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "BookStatus_new" AS ENUM ('PUBLICANDO', 'DESCONTINUADO', 'COMPLETADO');
...
ALTER TABLE "Book" ALTER COLUMN "status" SET DEFAULT 'PUBLICANDO';
COMMIT;
